...
|-----|-------------|------|---------|
 ...
 | graphNodeGroups | Groups of Graph Nodes to deploy | object | `{"block-ingestor":{"enabled":true,"env":{"DISABLE_BLOCK_INGESTOR":"false","NODE_ROLE":"index-node"},"includeInIndexPools":[],"replicaCount":1},"index":{"enabled":true,"env":{"NODE_ROLE":"index-node"},"includeInIndexPools":["default"],"replicaCount":1},"query":{"enabled":true,"env":{"NODE_ROLE":"query-node"},"replicaCount":1}}` |
