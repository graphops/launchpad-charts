# Temporalite Helm Chart

Deploy Temporalite, a distribution of Temporal that runs as a single process with zero runtime dependencies.
...
$ helm install my-release graphops/temporalite
```

## Configuring temporalite
...
|-----|-------------|------|---------|
 ...
 | image | Image for indexer-agent | object | `{"pullPolicy":"IfNotPresent","repository":"ghcr.io/graphops/docker-builds/temporalite","tag":""}` |
