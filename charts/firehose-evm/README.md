...
|-----|-------------|------|---------|
 ...
 | firehoseComponentDefaults.fireeth.metrics | Enable support for metrics | object | `{"addr":"0.0.0.0","enabled":false,"port":9102}` |
