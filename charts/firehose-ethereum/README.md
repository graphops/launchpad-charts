...
|-----|-------------|------|---------|
 ...
 | firehoseServiceDefaults.reader-node.initContainers | Init containers configuration | object | `{"10-init-nodeport":{"enabled":"{{ .Pod.fireeth.p2p.enabled }}"},"20-init-envsubst":{"enabled":"{{ .Pod.configMap.options.useEnvSubst }}"}}` |
