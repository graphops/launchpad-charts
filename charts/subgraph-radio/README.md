...
Deploy a preconfigured subgraph-radio container for to be used alongside the
...
|-----|-------------|------|---------|
 ...
 | config | [required] Configuration for subgraph-radio to connect to dependencies | object | `{"graphNode":{"adminApiUrl":null,"existingConfigMap":{"configFileKey":null,"configMapName":null}},"indexer":{"indexerAgentManagementUrl":null}}` |
 ...
 | image | Image for indexer-agent | object | `{"pullPolicy":"IfNotPresent","repository":"ghcr.io/graphops/docker-builds/subgraph-radio","tag":""}` |
