...
[![License](https://img.shields.io/badge/License-Apache%202.0-blue.svg)](https://opensource.org/licenses/Apache-2.0) ![Version: 0.1.10](https://img.shields.io/badge/Version-0.1.10-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square) ![AppVersion: 1.8.9](https://img.shields.io/badge/AppVersion-1.8.9-informational?style=flat-square)
...
|-----|-------------|------|---------|
 ...
 | celo.initChownData.image.tag | Container tag | string | `"1.38.0"` |
