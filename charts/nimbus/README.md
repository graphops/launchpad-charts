...
[![License](https://img.shields.io/badge/License-Apache%202.0-blue.svg)](https://opensource.org/licenses/Apache-2.0) ![Version: 0.6.16](https://img.shields.io/badge/Version-0.6.16-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square) ![AppVersion: multiarch-v26.7.0](https://img.shields.io/badge/AppVersion-multiarch--v26.7.0-informational?style=flat-square)
...
|-----|-------------|------|---------|
 ...
 | nimbus.initChownData.image.tag | Container tag | string | `"1.38.0"` |
