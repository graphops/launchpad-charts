...
|-----|-------------|------|---------|
 ...
 | config | Configuration for Toolbox to connect to dependencies | required | `{"graphNode":{"adminApiUrl":null,"existingConfigMap":{"configFileKey":null,"configMapName":null}},"indexer":{"indexerAgentManagementUrl":null}}` |
